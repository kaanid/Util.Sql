...
{
    public class SetClause : ISetClause
    {
        /// <summary>
        /// 方言
        /// </summary>
        ...
        public SetClause(IDialect dialect, IEntityResolver resolver, IEntityAliasRegister register, IParameterManager parameterManager)
        {
        ...
        public void Set(Dictionary<string,object> columns)
        {
        ...
        public void Set<TEntity>(TEntity model) where TEntity : class
        {
        ...
        public void Set<TEntity>(Expression<Func<TEntity, object[]>> columns, TEntity model) where TEntity : class
        {
