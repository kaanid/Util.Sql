...
namespace Util.Sql.Datas.Sql.Queries.Builders.Clauses
{
    ...
    /// delete子句
    /// </summary>
    public class DeleteClause : IDeleteClause
    {
        /// <summary>
        /// Sql项
        /// </summary>
        ...
        public DeleteClause(IDialect dialect, IEntityResolver resolver, IEntityAliasRegister register)
        {
            _dialect = dialect;
            _resolver = resolver;
            _register = register;
        ...
        public void Delete<TEntity>(string schema = null) where TEntity : class
        {
