...
using Util.Sql.Datas.Sql.Queries.Configs;
...
namespace Util.Sql.Datas.Sql.Queries
{
    /// <summary>
    /// Sql查询对象
    /// </summary>
    public abstract class SqlQueryBase : ISqlQuery
    {
        ...
        {
            return Util.Sql.Helpers.Convert.ToInt(ToScalar(connection, GetSql(), Params, GetDebugSql()));
        }
        ...
        {
            return Util.Sql.Helpers.Convert.ToInt(await ToScalarAsync(connection, GetSql(), Params, GetDebugSql()));
        }
        ...
        {
            return Util.Sql.Helpers.Convert.ToIntOrNull(ToScalar(connection, GetSql(), Params, GetDebugSql()));
        }
        ...
        {
            return Util.Sql.Helpers.Convert.ToIntOrNull(await ToScalarAsync(connection, GetSql(), Params, GetDebugSql()));
        }
